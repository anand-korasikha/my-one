...
import icon3 from '../../images/icon/illustrator.svg'
                            ...
                            <div className="col-xl-6 col-lg-6 col-12">
                                <div className="wpo-static-hero-inner">
                                    ...
                                    <div data-swiper-parallax="300" className="slide-sub-title">
                                        <h5>
                                            <TextType 
                                                text={["Frontend Developer", "React.js Specialist", "UI/UX Enthusiast"]}
                                                typingSpeed={75}
                                                pauseDuration={1500}
                                                showCursor={true}
                                                cursorCharacter="|"
                                    ...
                                    <div data-swiper-parallax="400" className="slide-text">
                                        <p>Designing the future, one interface at a time</p>
                                    </div>
                                    <div className="clearfix"></div>
                                    <div className="slide-btn"><Link className="theme-btn" to="contact" spy={true} smooth={true}  duration={500}>Getin Touch</Link></div>
                                </div>
                            </div>
                        </div>
                    </div>
